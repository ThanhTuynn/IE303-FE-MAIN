    ...
    useEffect(() => {
        const fetchRecommendations = async () => {
            ...
            try {
                ...
                const result = await aiRecommendationService.getUserBasedRecommendations(userId);
        ...
        <div className="bg-gray-50 text-gray-900 font-kanit min-h-screen">
            ...
            <section className="container-custom py-16 bg-white">
                <div className="text-center mb-12">
                    ...
                    {!isLoggedIn && (
                        <p className="text-gray-600 text-sm mb-4">Đăng nhập để nhận gợi ý món ăn cá nhân hóa từ AI</p>
                    )}
                </div>
                ...
                {recommendationsLoading ? (
                    <div className="flex justify-center items-center py-12">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-gray-600">
                                {isLoggedIn ? "Đang tìm món ăn phù hợp với bạn..." : "Đang tải món ăn..."}
                            </span>
                        </div>
                    </div>
                    ...
                    <div className="text-center py-12">
                        ...
                        <h3 className="text-xl font-semibold text-gray-800 mb-2">
                            {isLoggedIn ? "Chưa có đủ dữ liệu để đề xuất" : "Hãy đăng nhập để nhận gợi ý"}
                        </h3>
                            ...
                            <SwiperSlide key={food.id}>
                                ...
                                >
                                    ...
                                    {aiServiceAvailable && food.aiReason && (
                                        <p className="text-xs text-purple-600 italic mb-2 px-2">💡 {food.aiReason}</p>
                                    )}

      ...
      <div className="px-6 py-4">
        ...
        {[
          ...
          <div
            key={index}
            onClick={() =>
              setSelectedTime(`Thứ 3, 27/5/2025 ${slot.time}`)
            }
...
{[
  { label: 'Tiền mặt', icon: 'https://res.cloudinary.com/dbr85jktp/image/upload/v1748287327/CASH_ypopzk.png' },
  { label: 'Chuyển khoản ngân hàng', icon: 'https://res.cloudinary.com/dbr85jktp/image/upload/v1748287444/1052854_s2yqyr.png' },
  { label: 'MOMO', icon: 'https://res.cloudinary.com/dbr85jktp/image/upload/v1748287326/momo_nor95x.webp' },
  { label: 'ZaloPay', icon: 'https://res.cloudinary.com/dbr85jktp/image/upload/v1748287327/idv2DAbjER_1748287277081_omlczg.jpg' },
].map((option) => (
  <div
    key={option.label}
